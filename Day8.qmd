...
> Example 1: Tossing Two Coins. Consider the experiment of tossing two coins, and let $x$ be the number of heads observed. Find the probability associated with each value of the random variable $x$, assuming that the two coins are fair.
...
> Example 2: Discrete Probability Distribution. The random variable $x$ has the discrete probability distribution shown here:
