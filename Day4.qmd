...
- **Mild Outliers** fall between the inner and outer fences 
- **Extreme Outliers** fall beyond the outer fences.

Differentiating between mild and extreme outliers is crucial for accurate data analysis, as it helps in determining whether to include or exclude certain data points in statistical calculations. 
:::
:::
